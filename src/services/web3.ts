...
export const PROGRAM_ID = safePK('8m7wUvDdNc7U8nyutZKPLM4zn5CXuJWXovpKE6PvuiEj');
...
export const TOKEN_PROGRAM_ID = new PublicKey('TokenzQdBnBLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb'); // Token-2022 (Correct for $PREDICT)
