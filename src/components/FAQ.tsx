...
const faqs = [
    {
        question: 'What is OMEN?',
        answer: 'OMEN is a prediction dApp where you vote on crypto market predictions using $OMEN tokens. Correct predictions earn you rewards from the prize pool.',
    },
    {
        question: 'How do I buy $OMEN tokens?',
        answer: 'After our fair launch on Pump.fun, you can buy $OMEN by connecting your Solana wallet (Phantom/Solflare) and swapping SOL for $OMEN on the platform.',
    },
    {
        question: 'What makes this different from other memecoins?',
        answer: 'Unlike pure memecoins, $OMEN has real utility. You need tokens to vote on predictions, and accurate predictions earn rewards. Plus, we have deflationary tokenomics with a 1% burn on every transaction.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Vote on predictions using your $OMEN tokens. When a prediction closes, if you voted correctly, you receive a share of the rewards pool proportional to your vote.',
    },
];
